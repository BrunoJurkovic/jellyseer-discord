...
import 'package:jellyseer_discord/src/command_runner.dart';
...
void main() {
  group('JellyseerDiscordCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late JellyseerDiscordCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = JellyseerDiscordCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = JellyseerDiscordCommandRunner();
